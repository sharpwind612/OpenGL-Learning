...
int main()
{
	...
	// ------------------------------------
	Shader ourShader("../Resource/Shader/coordinate.vs", "../Resource/Shader/coordinate.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (unsigned int i = 0; i < 10; i++)
		{
			...
			float angle = 20.0f * i;
			model = glm::rotate(model, (float)glfwGetTime() * glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));//glm::vec3(1.0f, 0.3f, 0.5f)
